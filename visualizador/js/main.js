...
function main(){
    ...
    $('#estados').click(function(){
        var imgest =  "/static/sargazo/visualizador_sargazo/img/Simbo/estados.png";
        if($(this).is(':checked')){
            map.addLayer(wmsLayerestados);
    ...
    $('#anp').click(function(){
        var imganp = "/static/sargazo/visualizador_sargazo/img/Simbo/ANP.png";
        if($(this).is(':checked')){
    ...
    $('#hum').click(function(){
        var imganp = "/static/sargazo/visualizador_sargazo/img/Simbo/ANP.png";//jfkaljsdkfad
        if($(this).is(':checked')){
    ...
    $('#man').click(function(){
        var imgman = "/static/sargazo/visualizador_sargazo/img/Simbo/manglares.png";//jfkaljsdkfad
        if($(this).is(':checked')){
    ...
    var iconStyle = new ol.style.Style({
        image: new ol.style.Icon(({
            ...
            opacity: 0.7,
            zIndex: 0.8,
            src: '/static/sargazo/visualizador_sargazo/img/UNAM1.png'
        }))
    });
    ...
    imgsentineltc = "/static/sargazo/visualizador_sargazo/img/Simbo/SentinelTC.png";
