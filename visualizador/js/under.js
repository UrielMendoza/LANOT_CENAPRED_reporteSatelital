...
function under(){
    ...
    $('#hycomser').click(function(){
        if(con == 1){
            $('#hycomcont').html('<input type="checkbox" id="hycomtemp"/><label for="check1">&nbspTemperatura del mar</label><br>'
                +'<input type="checkbox" id="hycomvelo"/><label for="check1">&nbspCorriente superficial del mar</label><br>');
